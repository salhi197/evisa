...
<head>
    ...
    <link rel="icon" type="image/x-icon" href="{{asset('evisa/admin/assets/img/favicon.ico')}}" />
    ...
    <link href="{{asset('evsia/admin/plugins/apex/apexcharts.css')}}" rel="stylesheet" type="text/css">
    <link href="{{asset('evisa/admin/assets/css/dashboard/dash_1.css')}}" rel="stylesheet" type="text/css" />
...
<body class="alt-menu sidebar-noneoverflow">
    ...
    <div class="header-container">
        <header class="header navbar navbar-expand-sm">
            ...
            <div class="nav-logo align-self-center">
                <a class="navbar-brand" href="index.html"><img alt="logo" src="{{asset('evisa/admin/assets/img/90x90.jpg')}}"> <span class="navbar-brand-name">E-VISA</span></a>
            </div>
                    ...
                    <nav id="topbar">
                        <ul class="navbar-nav theme-brand flex-row  text-center">
                            <li class="nav-item theme-logo">
                                <a href="index.html">
                                    <img src="{{asset('evisa/admin/assets/img/90x90.jpg')}}" class="navbar-logo" alt="logo">
                                </a>
                            </li>
                        ...
                        <ul class="list-unstyled menu-categories" id="topAccordion">
                            ...
                            <li class="menu single-menu">
                                <a onclick="event.preventDefault(); document.getElementById('logout-form').submit();" href="#components" data-toggle="collapse" aria-expanded="false" class="dropdown-toggle">
                                    <div class="">
            ...
            <ul class="navbar-item flex-row nav-dropdowns">
                <li class="nav-item dropdown language-dropdown more-dropdown">
                    <div class="dropdown custom-dropdown-icon">
                        <a class="dropdown-toggle btn" href="#" role="button" id="customDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="{{asset('evisa/admin/assets/img/ca.png')}}" class="flag-width" alt="flag">
                        </a>
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="customDropdown">
                            ...
                            <a class="dropdown-item" data-img-value="de" data-value="de" href="javascript:void(0);"><img src="{{asset('evisa/admin/assets/img/de.png')}}" class="flag-width" alt="flag"> German</a>
                            <a class="dropdown-item" data-img-value="jp" data-value="jp" href="javascript:void(0);"><img src="{{asset('evisa/admin/assets/img/jp.png')}}" class="flag-width" alt="flag"> Japanese</a>
                            <a class="dropdown-item" data-img-value="fr" data-value="fr" href="javascript:void(0);"><img src="{{asset('evisa/admin/assets/img/fr.png')}}" class="flag-width" alt="flag"> French</a>
                            <a class="dropdown-item" data-img-value="ca" data-value="en" href="javascript:void(0);"><img src="{{asset('evisa/admin/assets/img/ca.png')}}" class="flag-width" alt="flag"> English</a>
                        </div>
                    </div>
                </li>
                ...
                <li class="nav-item dropdown user-profile-dropdown order-lg-0 order-1">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="user-profile-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media">
                            <img src="{{asset('evisa/admin/assets/img/90x90.jpg')}}" class="img-fluid" alt="admin-profile">
                        </div>
                    </a>
                        ...
                        <div class="widget widget-account-invoice-three">
                            ...
                            <div class="widget-heading">
                                <div class="wallet-usr-info">
                                    <div class="usr-name">
                                        <span><img src="{{asset('evisa/admin/assets/img/90x90.jpg')}}" alt="admin-profile" class="img-fluid"> Alan Green</span>
                                    </div>
                                    <div class="add">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="td-content customer-name"><img src="{{asset('evisa/admin/assets/img/90x90.jpg')}}" alt="avatar"><span>Luke Ivory</span></div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="td-content customer-name"><img src="{{asset('evisa/admin/assets/img/90x90.jpg')}}" alt="avatar"><span>Andy King</span></div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="td-content customer-name"><img src="{{asset('evisa/admin/assets/img/90x90.jpg')}}" alt="avatar"><span>Laurie Fox</span></div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="td-content customer-name"><img src="{{asset('evisa/admin/assets/img/90x90.jpg')}}" alt="avatar"><span>Ryan Collins</span></div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="td-content customer-name"><img src="{{asset('evisa/admin/assets/img/90x90.jpg')}}" alt="avatar"><span>Irene Collins</span></div>
                                                </td>
                                                <td>
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="td-content customer-name"><img src="{{asset('evisa/admin/assets/img/90x90.jpg')}}" alt="avatar"><span>Sonia Shaw</span></div>
                                                </td>
                                                <td>
                                ...
                                <div class="table-responsive">
                                    <table class="table table-scroll">
                                        ...
                                        <tbody>
                                            <tr>
                                                <td>
                                                    <div class="td-content product-name"><img src="{{asset('evisa/admin/assets/img/90x90.jpg')}}" alt="product">
    ...
    <script src="{{asset('evisa/admin/plugins/apex/apexcharts.min.js')}}"></script>
    <script src="{{asset('evisa/admin/assets/js/dashboard/dash_1.js')}}"></script>
    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
