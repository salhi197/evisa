...
<head>
    ...
    <link href="{{asset('evisa/admin/assets/css/authentication/form-2.css')}}" rel="stylesheet" type="text/css" />
    <!-- END GLOBAL MANDATORY STYLES -->
    <link rel="stylesheet" type="text/css" href="{{asset('evisa/admin/assets/css/forms/theme-checkbox-radio.css')}}">
    <link rel="stylesheet" type="text/css" href="{{asset('evisa/admin/assets/css/forms/switches.css')}}">
</head>
...
<body class="form">
            ...
            <div class="form-form-wrap">
                <div class="form-container">
                    <div class="form-content">
                        ...
                        <form class="text-left" class="login100-form validate-form" method="POST" action="{{route('login.admin')}}" aria-label="Login">
                                @csrf
    ...
    <script src="{{asset('evisa/admin/assets/js/authentication/form-2.js')}}"></script>
    <script>
