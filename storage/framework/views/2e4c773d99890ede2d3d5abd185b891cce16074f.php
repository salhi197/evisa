...
<head>
    ...
    <link href="<?php echo e(asset('evisa/assets/css/scrollspyNav.css')); ?>" rel="stylesheet" type="text/css" />
</head>
...
<body class="sidebar-noneoverflow" data-spy="scroll" data-target="#navSection" data-offset="100">
            ...
            <ul class="navbar-item flex-row nav-dropdowns">
                <li class="nav-item dropdown language-dropdown more-dropdown">
                    <div class="dropdown custom-dropdown-icon">
                        <a class="dropdown-toggle btn" href="#" role="button" id="customDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><img src="<?php echo e(asset('evisa/assets/img/ca.png')); ?>" class="flag-width" alt="flag">
                        ...
                        <div class="dropdown-menu dropdown-menu-right" aria-labelledby="customDropdown">
                            ...
                            <a class="dropdown-item" data-img-value="de" data-value="de" href="javascript:void(0);"><img src="<?php echo e(asset('evisa/assets/img/de.png')); ?>" class="flag-width" alt="flag"> German</a>
                            <a class="dropdown-item" data-img-value="jp" data-value="jp" href="javascript:void(0);"><img src="<?php echo e(asset('evisa/assets/img/jp.png')); ?>" class="flag-width" alt="flag"> Japanese</a>
                            <a class="dropdown-item" data-img-value="fr" data-value="fr" href="javascript:void(0);"><img src="<?php echo e(asset('evisa/assets/img/fr.png')); ?>" class="flag-width" alt="flag"> French</a>
                            <a class="dropdown-item" data-img-value="ca" data-value="en" href="javascript:void(0);"><img src="<?php echo e(asset('evisa/assets/img/ca.png')); ?>" class="flag-width" alt="flag"> English</a>
                        </div>
                    </div>
                </li>
                                    ...
                                    <div class="media">
                                        <div class="user-img">
                                            <div class="avatar avatar-xl">
                                                ...
                                                <img src="<?php echo e(asset('evisa/assets/img/90x90.jpg')); ?>" alt="admin-profile">
                                            </div>
                                        </div>
                ...
                <li class="nav-item dropdown user-profile-dropdown order-lg-0 order-1">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="user-profile-dropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <div class="media">
                            <img src="<?php echo e(asset('evisa/assets/img/90x90.jpg')); ?>" class="img-fluid" alt="admin-profile">
                        </div>
                    </a>
    ...
    <script src="<?php echo e(asset('evisa/assets/js/libs/jquery-3.1.1.min.js')); ?>"></script>
    <script src="<?php echo e(asset('evisa/bootstrap/js/popper.min.js')); ?>"></script>
