...
<head>
    ...
    <link href="<?php echo e(asset('evisa/gr/assets/css/loader.css')); ?>" rel="stylesheet" type="text/css" />
    <script src="<?php echo e(asset('evisa/gr/assets/js/loader.js')); ?>"></script>
    ...
    <link href="<?php echo e(asset('evisa/gr/plugins/apex/apexcharts.css')); ?>" rel="stylesheet" type="text/css">
    <link href="<?php echo e(asset('evisa/gr/assets/css/dashboard/dash_1.css')); ?>" rel="stylesheet" type="text/css" class="dashboard-analytics" />
        ...
        <header class="header navbar navbar-expand-sm">
            <ul class="navbar-item flex-row">
                <li class="nav-item theme-logo">
                    <a href="index.html">
                        <img src="<?php echo e(asset('evisa/gr/assets/img/logo.jpeg')); ?>" class="navbar-logo" alt="logo">
                    </a>
                </li>
            </ul>
            ...
            <ul class="navbar-item flex-row navbar-dropdown">
                ...
                <li class="nav-item dropdown user-profile-dropdown  order-lg-0 order-1">
                    <a href="javascript:void(0);" class="nav-link dropdown-toggle user" id="userProfileDropdown" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="<?php echo e(asset('evisa/gr/assets/img/logo.jpeg')); ?>" alt="admin-profile" class="img-fluid">
                    </a>
                    <div class="dropdown-menu position-absolute animated fadeInUp" aria-labelledby="userProfileDropdown">
                        <div class="user-profile-section">
                            <div class="media mx-auto">
                                <img src="<?php echo e(asset('evisa/gr/assets/img/90x90.jpg')); ?>" class="img-fluid mr-2" alt="avatar">
                                <div class="media-body">
        ...
        <div class="sidebar-wrapper sidebar-theme">
            ...
            <nav id="compactSidebar">
                <ul class="menu-categories">
                    ...
                    <li class="menu">
                        <a href="<?php echo e(route('demande.gr')); ?>" data-active="false" class="menu-toggle">
                            <div class="base-menu">
                                <div class="base-icons">
...
-->
    ...
    <script src="<?php echo e(asset('evisa/gr/plugins/perfect-scrollbar/perfect-scrollbar.min.js')); ?>"></script>
    <script src="<?php echo e(asset('evisa/gr/assets/js/app.js')); ?>"></script>
    <script>
        $(document).ready(function() {
            App.init();
        });
    </script>
    <script src="<?php echo e(asset('evisa/gr/assets/js/custom.js')); ?>"></script>
    <!-- END GLOBAL MANDATORY SCRIPTS -->

    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
    <script src="<?php echo e(asset('evisa/gr/plugins/apex/apexcharts.min.js')); ?>"></script>
    <script src="<?php echo e(asset('evisa/gr/assets/js/dashboard/dash_1.js')); ?>"></script>
    <!-- BEGIN PAGE LEVEL PLUGINS/CUSTOM SCRIPTS -->
