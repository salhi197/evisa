...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('evisa/gr/plugins/table/datatable/datatables.css')); ?>">
    <link rel="stylesheet" type="text/css" href="<?php echo e(asset('evisa/gr/plugins/table/datatable/dt-global_style.css')); ?>">
            ...
            <nav id="compactSidebar">
                <ul class="menu-categories">
                    <li class="menu active">
                        <a href="<?php echo e(route('gr')); ?>" data-active="true" class="menu-toggle">
                            <div class="base-menu">
...
-->
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="<?php echo e(route('demande.accept',['demande'=>$demande->id])); ?>"
    ...
    <script src="<?php echo e(asset('evisa/gr/plugins/table/datatable/datatables.js')); ?>"></script>
    <script>
